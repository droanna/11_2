...
def render_tab(df):
    ...
    layout = html.Div([html.H1('Produkty',style={'text-align':'center'}),
                        ...
                        html.Div([html.Div([dcc.Graph(id='pie-prod-cat',figure=fig)],style={'height': '500px','width':'50%'}),
                        html.Div([dcc.Dropdown(id='prod_dropdown',
                                    ...
                                    dcc.Graph(id='barh-prod-subcat')],style={'width':'50%', 'height': '500px'})],style={'display':'flex'}),
